" Vim color scheme Minimal Light "
" ---------------------------------------------------------------------- "
...
let g:colors_name="minimal-light"
...
let s:white       = { "gui": "#edeff2", "cterm": "231" }

let s:fg          = s:black
let s:bg          = s:white

let s:comment_fg  = { "gui": "#a0a1a7", "cterm": "247" }
let s:gutter_bg   = { "gui": "#F2F4F7", "cterm": "231" }
let s:gutter_fg   = { "gui": "#d4d4d4", "cterm": "252" }

let s:cursor_line = { "gui": "#F2F4F7", "cterm": "255" }
let s:color_col   = { "gui": "#F2F4F7", "cterm": "255" }
