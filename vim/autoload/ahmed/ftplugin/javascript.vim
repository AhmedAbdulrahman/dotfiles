...
"
" nnoremap <buffer><silent> gf :call ahmed#ftplugin#javascript#gotofile(expand('<cfile>'))<Enter>
" nnoremap <buffer><silent> <C-w>f :call ahmed#ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<Enter>
" nnoremap <buffer><silent> <C-w><C-f> :call ahmed#ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<Enter>
" nnoremap <buffer><silent> <C-w>gf :call ahmed#ftplugin#javascript#gotofile(expand('<cfile>'), 'tab split')<Enter>
"
...
""
function! ahmed#ftplugin#javascript#gotofile(fname, ...) abort
	if empty(a:fname)
		return v:false
	endif
