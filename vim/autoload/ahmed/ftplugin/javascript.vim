...
" nnoremap <buffer><silent> <C-w>f :call ahmed#ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<CR>"
" nnoremap <buffer><silent> <C-w><C-f> :call ahmed#ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<CR>"
" nnoremap <buffer><silent> <C-w>gf :call ahmed#ftplugin#javascript#gotofile(expand('<cfile>'), 'tab split')<CR>"
""
