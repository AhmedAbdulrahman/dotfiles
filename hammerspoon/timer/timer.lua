...
module.cfg = {
	...
	icon  = utils.toPath(utils.toPath(utils.toPath(os.getenv('HOME'), '.hammerspoon'),   'assets'), 'tidy-clock-icon.png'),
	sound = utils.toPath(utils.toPath(utils.toPath(os.getenv('HOME'), '.hammerspoon'),   'assets'), 'alert.caf'),
	volume = 1.0,
}
module.start()
