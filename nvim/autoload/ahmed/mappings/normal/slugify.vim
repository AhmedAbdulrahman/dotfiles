...
""
" nnoremap <silent> <Plug>SlugifyNormal ciw<C-R>=mappings#slugify#normal#(getreg('"'))<CR> :silent! call repeat#set("\<Plug>SlugifyNormal")<CR>"
" vnoremap <silent> <Plug>SlugifyVisual c<C-R>=mappings#slugify#normal#(getreg('"'))<CR> :silent! call repeat#set("\<Plug>SlugifyVisual")<CR>"
" nmap <silent> <leader>s <Plug>SlugifyNormal"
" vmap <silent> <leader>s <Plug>SlugifyVisual"
""

function! mappings#normal#slugify#(string) abort
