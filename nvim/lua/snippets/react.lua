...
local typescript = require('snippets.common.typescript')
...
ls.add_snippets(nil, {
  javascriptreact = vim.tbl_extend('force', {}, typescript, react),
  typescriptreact = vim.tbl_extend('force', {}, typescript, react),
})
