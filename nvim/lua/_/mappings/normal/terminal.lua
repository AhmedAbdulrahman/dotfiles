...
--
-- tnoremap <silent> <C-z> <C-\><C-n>:lua require('_/config/mappings/normal/terminal').toggle()<CR>
-- nnoremap <silent> <C-z> :lua require('_/config/mappings/normal/terminal').toggle()<CR>
...
terminal.open = function()
  ...
  vim.cmd('startinsert')
  vim.cmd("autocmd! TermClose <buffer> lua require('ahmed/mappings/normal/terminal').close(true)")
