    ...
    config = function()
      ...
      cmp.setup({
        ...
        sources = {
          ...
          { name = 'nvim_lua', priority = 5, group_index = 2  },
        ...
        reselect = cmp.PreselectMode.Item,
      ...
      -- │ Color                                                    │
      -- ╰──────────────────────────────────────────────────────────╯
      set_highlight({ group = 'CmpItemKindDefault', foreground = colors.red })
    end,
  },
}
