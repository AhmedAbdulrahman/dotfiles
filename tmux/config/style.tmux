...
status_date_time="#[fg=colour237]#[fg=#8d929b]%A, %d %b %Y %H:%M#[fg=colour237] "
status_prayer_times="#[fg=#ffa7c4]#(~/.tmux/scripts/tmux-next-prayer) #[fg=#ffa7c4]⦁ "

set -g status-right-length 300
set -g status-right "${status_prefix}${status_node_version}${status_wifi}${status_prayer_times}${status_date_time}"
